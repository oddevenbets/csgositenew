let isDemoSpin = false;
  ...
  fetch('/user')
    ...
    fetch('/user')
      ...
      const guns = [ 
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgposbaqKAxf0Ob3djFN79eJmo-Chcj4OrzZgiUEvJJz3ujEoomijAHg8kI_N2mgI4HBIVc7ZVzX-FW6wujsg5fptJ_J1zI97WjKBCQa/360fx360f', label: 'Glock-18 Neo-Noir', wear: 'FN', price: 69.09, gems: 69.09, type: 'Glock-18', weight: 0.2 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpot621FAR17PLfYQJM6dO4m4mZqPv9NLPF2DpSsJVyiLmRot73jFbt-xJtMjr2cYKRIVBrNVuD-lO4k-a515butJzXiSw01PxfcRM/360fx360f', label: 'AWP Neo-Noir', wear: 'MW', price: 33.75, gems: 33.75, type: 'AWP', weight: 0.3 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpou-6kejhjxszFJTwW09Kzm7-FmP7mDLbUkmJE5Yt02L7Crd6ljFfhqkRpNmj0IoHGJg48NFHQ-APrk-fmgJS47ZqaznEwpGB8snTjxNBG/360fx360f', label: 'M4A4 Neo-Noir', wear: 'FT', price: 24.53, gems: 24.53, type: 'StatTrak™ M4A4', weight: 0.5 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpoo6m1FBRp3_bGcjhQ09-jq5WYh-TLPbTYhFRZ7cRnk6fD8NmtjlLtrkM5YGCgJIXAewA-Zl3U_lXvl-zmjJPpvZ_KnyZl73Im-z-DyIm5FT5s/360fx360f', label: 'USP-S Neo-Noir', wear: 'FN', price: 20.15, gems: 20.15, type: 'USP-S', weight: 1 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXQ9QVcJY8gulRfSV7cTur_h56KHE59IjtZs7WaLAhs173NJGVE6ojgkILbzvagY-nUxGhU7MQkj-_D99mm2lGxrxBlMW37JoKUbEZgNtg-0UYW/360fx360f', label: 'NEO (Gold) | Berlin 2019', wear: 'Item', price: 12.36, gems: 12.36, type: 'Sticker', weight: 3 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpoo7e1f1Jfxv7YJWh94tm5q46EnuXLO77QgHIfv5Yo2byZ892g2ALs-ks4ajr1dY6UIFJtNVzV-AC7lOnuh5W4usvKzmwj5Hfiiqdk5Q/360fx360f', label: 'UMP-45 Neo-Noir', wear: 'BS', price: 5.49, gems: 5.49, type: 'UMP-45', weight: 25 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXQ9QVcJY8gulRfSV7cTur_h56KHE59IjtZs7Xrf1NlhKGbJG9EuNmyzIPTxvWlMeKEkGgH6sRwj-rDrIj331Di-UBsYXezetGraE7rlw/360fx360f', label: 'NEO | Berlin 2019', wear: 'Item', price: 0.19, gems: 0.19, type: 'Sticker', weight: 70 }
      ];

      const rewards = [
        { value: "0.19", weight: 70 },
        { value: "5.49", weight: 25 },
        { value: "12.36", weight: 3 },
        { value: "20.15", weight: 1 },
        { value: "24.53", weight: 0.5 },
        { value: "33.75", weight: 0.3 },
        { value: "69.09", weight: 0.2 }
      ];
      ...
      function getGlowClass(gun) {
        if (gun.label === 'NEO | Berlin 2019') return 'glow-grey';
        if (gun.label === 'UMP-45 Neo-Noir') return 'glow-blue';
        if (gun.label === 'NEO (Gold) | Berlin 2019') return 'glow-purple';
        if (gun.label === 'USP-S Neo-Noir') return 'glow-pink';
        if (['M4A4 Neo-Noir', 'AWP Neo-Noir'].includes(gun.label)) return 'glow-red';
        if (gun.label === 'Glock-18 Neo-Noir') return 'glow-yellow';
        return '';
      }
      ...
      function doActualSpin(isDemo = false){
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            if (['Glock-18 Neo-Noir'].includes(resultGun.label)) {
