let isDemoSpin = false;
  ...
  fetch('/user')
    ...
    fetch('/user')
      ...
      const guns = [ 
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpou-6kejhz2v_Nfz5H_uO7wIHahMj2P7rSnVRd59FkmdbN_Iv9nBrg8hdram6gJoGRdAE_ZVqC_FS2l-68gcW06ZibnCNj7Cgk4X2Olh3hn1gSOQ4iuyOq/360fx360f', label: 'Black Lotus', wear: 'MW', price: 37.73, gems: 37.73, type: 'StatTrak™ M4A1-S', weight: 0.5 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpou-6kejhz2v_Nfz5H_uOxh7-Gw_alDKjZl39F7ddOhuDG_Zi7jQPh8hJqNW3wctWSdANvN1-CqFC5kOjv1JPotMzAzSA2vykms3aPzQv3309Tx2RKrQ/360fx360f', label: 'Leaded Glass', wear: 'FN', price: 20.14, gems: 20.14, type: 'M4A1-S', weight: 0.5 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpou-6kejhz2v_Nfz5H_uO-jb-ZkvPgOrzUhFRd4cJ5nqeZpo-j2Azs-kFkYG_7cYKRdQI3Ml6C_1a6xea-hJG9vJSamHBgvSYr-z-DyIHgiEdl/360fx360f', label: 'Blood Tiger', wear: 'FN', price: 6.59, gems: 6.59, type: 'M4A1-S', weight: 9 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpou-6kejhz2v_Nfz5H_uO1gb-Gw_alIITXk25V4ct2te_T8ILvkWu4ohQ0J3f6LNSdcg5rNF_Yr1bswLy505G8752dy3dguigltCmJlxPmiUtOOLRmm7XAHjOl7uFi/360fx360f', label: 'Emphorosaur-S', wear: 'FN', price: 2.91, gems: 2.91, type: 'M4A1-S', weight: 15 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpou-6kejhz2v_Nfz5H_uO-jb-dluX9MLrcmVRd4cJ5nqeUotWg0QLi_0VvNm-hcYXBJA4_YgzZr1W7x7-7jcfuvpSfmyZruyEr-z-DyFqgdKfY/360fx360f', label: 'VariCamo', wear: 'MW', price: 1.22, gems: 1.22, type: 'M4A1-S', weight: 25 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpou-6kejhz2v_Nfz5H_uO-jb-EgfLmI7rChVRV58p1huz--Nj02UeLoxY9JSDtddLHJFRoZg7Q-ATqwLvo18Tv7cvMwHMw7iRw7SvZn0Pm0hwaPLQ50eveFwuhmXC3mw/360fx360f', label: 'Wash me plz', wear: 'BS', price: 0.05, gems: 0.05, type: 'M4A1-S', weight: 50 }
      ];

      const rewards = [
        { value: "0.05", weight: 50 },
        { value: "1.22", weight: 25 },
        { value: "2.91", weight: 15 },
        { value: "6.59", weight: 9 },
        { value: "20.14", weight: 0.5 },
        { value: "37.73", weight: 0.5 }
      ];
      ...
      function getGlowClass(gun) {
        if (gun.label === 'Wash me plz') return 'glow-grey';
        if (gun.label === 'VariCamo') return 'glow-blue';
        if (gun.label === 'Emphorosaur-S') return 'glow-purple';
        if (gun.label === 'Blood Tiger') return 'glow-pink';
        if (['Leaded Glass', 'Black Lotus'].includes(gun.label)) return 'glow-yellow';
        return '';
      }
      ...
      function doActualSpin(isDemo = false){
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            if (['Black Lotus', 'Leaded Glass'].includes(resultGun.label)) {
            ...
            } else if (['Blood Tiger', 'Emphorosaur-S'].includes(resultGun.label)) {
              // Purple or pink pull
              resultBox.style.borderColor = "#9b5de5"; // purple glow
              resultHeader.style.borderColor = "#9b5de5";
            } else if (['VariCamo'].includes(resultGun.label)) {
              // Blue pull
