let isDemoSpin = false;
  ...
  fetch('/user')
    ...
    fetch('/user')
      ...
      const guns = [ 
      { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgposbaqKAxf0Ob3fDJM6cWJk4yElPzLPr7Vn35cppRyiLyVpI2hi1HkrkBsMTv0d4acIVM9Z17S_QK2kuy90MC0uZrNzyN9-n51HyDSDDs/360fx360f', label: 'Glock-18 Franklin', wear: 'FT', price: 47.40, gems: 47.40, type: 'Glock-18', weight: 0.5 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpopujwezhjxszFfjNH9eO6nYeDg7mnZL-IkjMIu5cp3r-WptStiVG3qBFla27wLNXGIVM3N17YqADvxO7rm9bi6-wO2R-D/360fx360f', label: 'P250 Franklin', wear: 'FN', price: 2.14, gems: 2.14, type: 'P250', weight: 7.5 },
        { name: '../assets/DirtyMoney.png', label: 'Dirty Money', wear: 'Item', price: 0.40, gems: 0.40, type: 'Sticker', weight: 92 }
      ];

      const rewards = [
        { value: "0.40", weight: 92 },
        { value: "2.14", weight: 7.5 },
        { value: "47.40", weight:  0.5 }
      ];
      ...
      function getGlowClass(gun) {
        if (gun.label === 'Dirty Money') return 'glow-grey';
        if (gun.label === 'P250 Franklin') return 'glow-pink';
        if (gun.label === 'Glock-18 Franklin') return 'glow-yellow';
        return '';
      }
      ...
      function doActualSpin(isDemo = false){
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            if (['Glock-18 Franklin'].includes(resultGun.label)) {
            ...
            } else if (['P250 Franklin'].includes(resultGun.label)) {
              // Pink pull
