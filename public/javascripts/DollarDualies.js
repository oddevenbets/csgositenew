...
fetch('/user')
  ...
  const guns = [ 
    { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpos7asPwJf2-r3fDxQ5dK3q5OemeX9IL7ummJW4NE_2rrH89z23FXiqBJsZG-nd4eVJlU-ZF6E-gK7we6-hZDt6JXAnHo2sj5iuyhXECmgPw/360fx360f', label: 'Marina', wear: 'FN', price: 17.66, gems: 17.66, type: 'Dual Berettas', weight: 1 },
    { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpos7asPwJf0v73fi5R5dqvq5KOk8j4OrzZgiVQuJQki7iZ99vx0AOw_RA6MWz7JdSXcwY6YwyD_lTow7q905W7vs6f1zI97cR6kGPX/360fx360f', label: 'Hemoglobin', wear: 'MW', price: 11.78, gems: 11.78, type: 'Dual Berettas', weight: 2.5 },
    { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpos7asPwJf0Ob3dDFL-Nmlq5WZlfb6IK_ehGZu5Mx2gv2PoNr02Abn_Uo9YGj2J4Kcegc9NAvV_le_yeq60JG9tcuaznNjviIh52GdwUIFUEJ8MQ/360fx360f', label: 'Urban Shock', wear: 'FN', price: 4.46, gems: 4.46, type: 'Dual Berettas', weight: 6.5 },
    { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpos7asPwJfwPz3YTxM-NSzhr-HnvD8J_XQx25X7MFw0-rApInwjgfsqkY6YWHzJIaWJFU7MgqF_lbvle3r1Me8ot2Xnk7JCUDK/360fx360f', label: 'Panther', wear: 'MW', price: 2.16, gems: 2.16, type: 'Dual Berettas', weight: 20 },
    { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpos7asPwJf0uL3dzJQ79myq4yCkP_gfe-Fkj8Eu5wn0-yZ99-h3ALmqUQ9YW_zd9XEIQNtaFCB-VS_kObsg8ei_MOe-yn9l4Y/360fx360f', label: 'Stained', wear: 'FN', price: 0.29, gems: 0.29, type: 'Dual Berettas', weight: 25 },
    { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpos7asPwJfwPzLeQJD786vmImIqPDmOqvCqWNU6dNoxO2YotujjFflrRI9ZG37cdWSelBoMlvTqwO2lO3rjMW1vZjKwSNn6HU8pSGKMP3Q-8Y/360fx360f', label: 'BorDeux', wear: 'BS', price: 0.03, gems: 0.03, type: 'Dual Berettas', weight: 45 }
  ];

  const rewards = [
    { value: "0.03", weight: 45 },
    { value: "0.29", weight: 25 },
    { value: "2.16", weight: 20 },
    { value: "4.46", weight: 6.5 },
    { value: "11.78", weight: 2.5 },
    { value: "17.66", weight: 1 }
  ];
  ...
  function getGlowClass(gun) {
    if (gun.label === 'BorDeux') return 'glow-grey';
    if (gun.label === 'Stained') return 'glow-blue';
    if (gun.label === 'Panther') return 'glow-purple';
    if (gun.label === 'Urban Shock') return 'glow-pink';
    if (gun.label === 'Hemoglobin') return 'glow-red';
    if (gun.label === 'Marina') return 'glow-red';
    return '';
  }
  ...
  function doActualSpin(isDemo = false){
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        if (['Marina'].includes(resultGun.label)) {
