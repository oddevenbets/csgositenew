...
fetch('/user')
  ...
  const guns = [ 
    { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgposbupIgthwczLZAJF7dC_mL-OlPjLP7LWnn8f6pAg3buWrN7z2gXm_0BqZjqlcIGVIANtYF7T_Vm9wu3p0MO8uZ7JzGwj5Hd0pQL-vQ/360fx360f', label: 'Eco', wear: 'FT', price: 16.82, gems: 16.82, type: 'StatTrak™ Galil AR', weight: 1 },
    { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgposbupIgthwczPYgJF7dC_mL-dlvnwMrfummJW4NE_jriQpdWn3AHt-xJtYGyhdYSUcgA5ZVDV-VLvw73r05Dq75TJmCRquz5iuyizKHt3QA/360fx360f', label: 'Vandal', wear: 'FN', price: 7.33, gems: 7.33, type: 'StatTrak™Galil AR', weight: 12 },
    { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgposbupIgthwczbfgJF_tmzmr-HnvD8J_WCxjsHuZFz0rqY946h0Ae2rxBuYzr2LYPDcQ5oY1iGqFS6kObqhMS_ot2XnrGWJTew/360fx360f', label: 'Green Apple', wear: 'FN', price: 0.37, gems: 0.37, type: 'Galil AR', weight: 27 },
    { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgposbupIgthwczLZAJS49Cvq4eZkvL6DLzQmmJd18h0juDU-MKjjgCxqhBqZDz7cYPBeg85YlrW_gO5k-vshJO76ZTBySYwsnYhs3_ZgVXp1lfHVYXg/360fx360f', label: 'NV', wear: 'WW', price: 0.03, gems: 0.03, type: 'Galil AR', weight: 60 }
  ];

  const rewards = [
    { value: "0.03", weight: 60 },
    { value: "0.37", weight: 27 },
    { value: "7.33", weight: 12 },
    { value: "16.82", weight: 1 }
  ];
  ...
  function getGlowClass(gun) {
    if (gun.label === 'NV') return 'glow-grey';
    if (gun.label === 'Green Apple') return 'glow-blue';
    if (gun.label === 'Vandal') return 'glow-red';
    if (gun.label === 'Eco') return 'glow-yellow';
    return '';
  }
  ...
  function doActualSpin(isDemo = false){
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        if (['Eco'].includes(resultGun.label)) {
        ...
        } else if (['Vandal'].includes(resultGun.label)) {
          // Red pull
          resultBox.style.borderColor = "#EB4B4B"; // red glow
          resultHeader.style.borderColor = "#EB4B4B";
        } else if (['Green Apple'].includes(resultGun.label)) {
          // Blue pull
