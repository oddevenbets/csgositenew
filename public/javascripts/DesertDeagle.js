let isDemoSpin = false;
  ...
  fetch('/user')
    ...
    fetch('/user')
      ...
      const guns = [ 
      { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgposr-kLAtl7PTbTjlH7du6kb-GkvT8MoTdn2xZ_Isk2bmXot_33AK3rkpoZj_xJYKRJlRraAyF-Va-l7jr05TpvM_PzyQypGB8slsMoZQy/360fx360f', label: 'Mecha Industries', wear: 'FN', price: 11.81, gems: 11.81, type: 'Desert Eagle', weight: 2 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgposr-kLAtl7PfNcDpO6eOlmoGAksjkMq_Fk3lf18l4jeHVu9uj3VXs-RA9YT-iI4GXJg85aFDV81nqxefqhsK-6JWdyCBhuXMi53nD30vgPDV_4x0/360fx360f', label: 'Serpent Strike', wear: 'FN', price: 4.69, gems: 4.69, type: 'Desert Eagle', weight: 8},
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgposr-kLAtl7PDdTjJU6c6mlZOYqPblJrrukm5Q78l0teXI8oThxgXg-BdvNWylJoHBcgU7Z1DRr1i9yOi91pG_tcmbn3Jh6yEi4XnayUepwUYbGBHo8Eg/360fx360f', label: 'Tilted', wear: 'FN', price: 1.80, gems: 1.80, type: 'Sticker', weight: 20 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgposr-kLAtl7PDdTjlH7du6kb-Zkuf4OrjQqWdY781lxOjArdSg0VXl80tqY27xJIeSIwE-NVGF_1Xowbu9g5ftuM7JzXdnuSI8pSGKOCoVgHE/360fx360f', label: 'Blue Ply', wear: 'FT', price: 0.48, gems: 0.48, type: 'Desert Eagle', weight: 25 },
        { name: 'https://community.cloudflare.steamstatic.com/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgposr-kLAtl7PvRTjBN-Mi6kYS0hPb6N4Tdn2xZ_IskjruWpd6i31Ls8xA6YGnwctDBcg84M1DU-1i_l7u6jcC5v5nKmnYypGB8suCnx0qw/360fx360f', label: 'Mudder', wear: 'FT', price: 0.03, gems: 0.03, type: 'Desert Eagle', weight: 45 }
      ];

      const rewards = [
        { value: "0.03", weight: 45 },
        { value: "0.48", weight: 25 },
        { value: "1.80", weight:  20 },
        { value: "4.69", weight:  8 },
        { value: "11.81", weight:  2 }
      ];
      ...
      function getGlowClass(gun) {
        if (gun.label === 'Mudder') return 'glow-grey';
        if (gun.label === 'Blue Ply') return 'glow-blue';
        if (gun.label === 'Tilted') return 'glow-purple';
        if (gun.label === 'Serpent Strike') return 'glow-red';
        if (gun.label === 'Mecha Industries') return 'glow-yellow';
        return '';
      }
      ...
      function doActualSpin(isDemo = false){
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            if (['Mecha Industries'].includes(resultGun.label)) {
